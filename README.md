...
途径：一般建议新手从交易所购买加密货币，这里以火币（三大中文交易所之一） [安卓点击直接下载app](./bin/huobi.apk) 为例。安装后完成注册，会显示注册成功，立即买币。这里建议购买泰达币（USDT），为什么不购买大名鼎鼎的比特币（BTC），因为直接购买BTC价格偏高，而USDT恒等于1美元可以随时用来交易BTC（价格更低）和其他任意加密货币。
